...
/* WEBPACK VAR INJECTION */(function(global, jQuery) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wordpress_dom_ready__ = __webpack_require__(690);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_CalderaFormsRender__ = __webpack_require__(691);
...
Object.defineProperty(global.wp, 'element', {
	get: function get() {
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a;
	}
});


Object(__WEBPACK_IMPORTED_MODULE_2__wordpress_dom_ready__["a" /* default */])(function () {
	jQuery(document).on('cf.form.init', function (e, obj) {
		...
		__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(wp.element.createElement(__WEBPACK_IMPORTED_MODULE_3__components_CalderaFormsRender__["a" /* CalderaFormsRender */], {
			cfState: state,
			formId: formId,
			formIdAttr: idAttr,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_get_prototype_of__ = __webpack_require__(692);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_get_prototype_of___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_get_prototype_of__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_classCallCheck__ = __webpack_require__(695);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_classCallCheck___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_classCallCheck__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass__ = __webpack_require__(696);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_possibleConstructorReturn__ = __webpack_require__(700);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_possibleConstructorReturn___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_possibleConstructorReturn__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_inherits__ = __webpack_require__(701);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__CalderaFormsFieldRender__ = __webpack_require__(707);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_validator_lib_isEmpty__ = __webpack_require__(760);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_validator_lib_isEmpty___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_validator_lib_isEmpty__);
...
var CalderaFormsRender = function (_Component) {
	__WEBPACK_IMPORTED_MODULE_6_babel_runtime_helpers_inherits___default()(CalderaFormsRender, _Component);
  ...
  */
	function CalderaFormsRender(props) {
		__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_classCallCheck___default()(this, CalderaFormsRender);

		var _this = __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_possibleConstructorReturn___default()(this, (CalderaFormsRender.__proto__ || __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_get_prototype_of___default()(CalderaFormsRender)).call(this, props));
  ...
  */
	...
	__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(CalderaFormsRender, [{
		key: 'getCfState',
		...
		value: function getHandler(fieldIdAttr) {
			...
			if (!handlers.hasOwnProperty(fieldIdAttr)) {
				handlers[fieldIdAttr] = function (event) {
					return _this2.setFieldValue(fieldIdAttr, event.target.value);
				};
			}
   ...
   */
				...
				if (!conditionalEventSubscriptions[fieldIdAttr].hasOwnProperty(conditionalEvent)) {
					conditionalEventSubscriptions[fieldIdAttr][conditionalEvent] = _this3.getCfState().events().attatchEvent('cf.conditionals.' + conditionalEvent, function (eventData, eventName) {
						if (formIdAttr === eventData.formIdAttr) {
							...
							switch (eventType) {
								case 'hide':
									_this3.setFieldShouldShow(_fieldIdAttr, false);
									break;
								case 'show':
		...
		value: function isFieldValid(fieldIdAttr) {
			return this.isFieldRequired(fieldIdAttr) && !__WEBPACK_IMPORTED_MODULE_10_validator_lib_isEmpty___default()(this.state[fieldIdAttr]);
		}
			...
			return wp.element.createElement(
				...
				fieldsToControl.map(function (field) {
					...
					field = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, field, {
						fieldValue: _this4.getFieldValue(fieldIdAttr)
					});

					var isInvalid = shouldBeValidating && !_this4.isFieldValid(fieldIdAttr);

					_this4.subscribe(fieldIdAttr);
					var props = {
						field: field,
						onChange: _this4.getHandler(fieldIdAttr),
						shouldShow: state[shouldShowKey(fieldIdAttr)],
						shouldDisable: state[shouldDisableKey(fieldIdAttr)]
					};

					return wp.element.createElement(__WEBPACK_IMPORTED_MODULE_9__CalderaFormsFieldRender__["b" /* CalderaFormsFieldRender */], __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, props, {
						key: outterIdAttr,
						isInvalid: isInvalid
					}));
				})
...
CalderaFormsRender.propTypes = {
	cfState: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.object.isRequired,
	formId: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.string.isRequired,
	fieldsToControl: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_9__CalderaFormsFieldRender__["a" /* CalderaFormsFieldPropType */]),
	formIdAttr: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.string.isRequired,
	shouldBeValidating: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.bool.isRequired
};
