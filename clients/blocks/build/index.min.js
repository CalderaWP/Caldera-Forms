...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return SET_FORMS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return SET_FORM; });
/* unused harmony export SET_CURRENT_FORM_ID */
/* unused harmony export ADD_FORM_PREVIEW */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return actionFunctions; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__caldera_labs_state__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__caldera_labs_state___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__caldera_labs_state__);
 ...
 */
var actionFunctions = __WEBPACK_IMPORTED_MODULE_0__caldera_labs_state__["store"].actions;
...
const SET_FORMS = exports.SET_FORMS = 'SET_FORMS';
const SET_FORM = exports.SET_FORM = 'SET_FORM';
const ADD_FORM_PREVIEW = exports.ADD_FORM_PREVIEW = 'ADD_FORM_PREVIEW';
const NEW_FORM = exports.NEW_FORM = 'NEW_FORM';
 ...
 */
const setForm = exports.setForm = form => {
    return {
        type: SET_FORM,
        form: form
    };
 ...
 */
const setForms = exports.setForms = forms => {
    return {
        type: SET_FORMS,
        forms: forms
    };
 ...
 */
const addFormPreview = exports.addFormPreview = (formId, preview) => {
    return {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign__ = __webpack_require__(67);
 ...
 * @returns {boolean|*}
 */
const getForm = exports.getForm = (state, formId) => {
 ...
 * @returns {*}
 */
const getForms = exports.getForms = state => {
    let forms = {};
 ...
 * @returns {string}
 */
const getFormPreview = exports.getFormPreview = (state, formId) => {
 ...
 */
const getFormPreviews = exports.getFormPreviews = state => {
 ...
 * @return {boolean}
 */
const formHasId = exports.formHasId = (form, formId) => {
 ...
 * @returns {String|bool}
 */
const getFormId = exports.getFormId = form => {
    if (form.hasOwnProperty('ID')) {
        return form.ID;
    }
    if (form.hasOwnProperty('formId')) {
 ...
 * @returns {Object}
 */
const mapArrayOfFormsToObject = exports.mapArrayOfFormsToObject = forms => {
 ...
 * @param {String} formId
 */
const findFormById = exports.findFormById = (forms, formId) => {
 ...
 * @param {String} formId
 */
const findFormIndexById = exports.findFormIndexById = (forms, formId) => {
    if (!Array.isArray(forms) || !forms.length) {
        return false;
    }
 ...
 * @returns {string}
 */
const generateId = exports.generateId = generateFor => {
...
exports.formsReducer = exports.initialStateWithForms = exports.DEFAULT_STATE = undefined;
 ...
 */
const initialStateWithForms = exports.initialStateWithForms = forms => {
    if (!Array.isArray(forms)) {
 ...
 * @returns {*}
 */
const formsReducer = exports.formsReducer = (state = DEFAULT_STATE, action) => {
    switch (action.type) {
        ...
        case _actions.SET_FORM:
            if (!Array.isArray(state.forms) || !state.forms.length) {
                ...
                const index = (0, _util.findFormIndexById)(state.forms, action.form.ID);
                if (-1 <= index) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functions__ = __webpack_require__(90);
...
exports.calderaFormsReduxStore = exports.calderaFormsFormState = exports.CALDERA_FORMS_STORE_SLUG = undefined;
...
const CALDERA_FORMS_STORE_SLUG = exports.CALDERA_FORMS_STORE_SLUG = 'CALDERA_FORMS/FORMS';
/**
 ...
 */
const calderaFormsFormState = exports.calderaFormsFormState = {
...
const calderaFormsReduxStore = exports.calderaFormsReduxStore = (0, _redux.createStore)((0, _redux.combineReducers)(reducers), window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createStore__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__combineReducers__ = __webpack_require__(196);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bindActionCreators__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__applyMiddleware__ = __webpack_require__(198);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Symbol_js__ = __webpack_require__(132);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(23), __webpack_require__(159)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createStore__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_es_isPlainObject__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cfAdmin__ = __webpack_require__(88);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_asyncToGenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__state_actions_form__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__state_actions_mutations__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__state_actions_functions__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__state_api_cfAdmin__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__state_api__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__caldera_labs_state__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__caldera_labs_state___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__caldera_labs_state__);
...
var DEFAULT_STATE = {
    forms: Array.isArray(__WEBPACK_IMPORTED_MODULE_5__state_api_cfAdmin__["b" /* printedData */].forms) ? __WEBPACK_IMPORTED_MODULE_5__state_api_cfAdmin__["b" /* printedData */].forms : [],
    formPreviews: {}
};
...
var requestFormPreview = function requestFormPreview(state, formId) {
    ...
    wp.apiRequest({
        url: "" + __WEBPACK_IMPORTED_MODULE_5__state_api_cfAdmin__["a" /* cfAdmin */].api.form + formId + "?preview=true",
        method: 'GET',
        cache: true
...
var STORE = {
    reducer: function reducer() {
        ...
        return __WEBPACK_IMPORTED_MODULE_7__caldera_labs_state__["store"].reducers.formsReducer(DEFAULT_STATE, action);
    },

    actions: __WEBPACK_IMPORTED_MODULE_7__caldera_labs_state__["store"].actions,
    selectors: __WEBPACK_IMPORTED_MODULE_7__caldera_labs_state__["store"].selectors,
    resolvers: {
        getForm: function () {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return Object(__WEBPACK_IMPORTED_MODULE_6__state_api__["a" /* requestForm */])(formId);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__store__ = __webpack_require__(217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_formChooser__ = __webpack_require__(511);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_FormPreview__ = __webpack_require__(512);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_values__ = __webpack_require__(96);
...
var FormChooser = function FormChooser(props) {
    var opts = !Array.isArray(props.forms) ? __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_values___default()(props.forms) : props.forms;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__store__ = __webpack_require__(217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functions_appendAssets__ = __webpack_require__(513);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys__ = __webpack_require__(174);
