...
<div class="caldera-config-group">
    ...
    <div class="caldera-config-field">
        <input type="text" class="cfdatepicker-set-format block-input field-config" id="{{id}}" name="{{_name}}[start-date]" value="{{start-date}}">
...
<div class="caldera-config-group">
    ...
    <div class="caldera-config-field">
        <input type="text" class="cfdatepicker-set-format block-input field-config" id="{{id}}" name="{{_name}}[end-date]" value="{{end-date}}">
