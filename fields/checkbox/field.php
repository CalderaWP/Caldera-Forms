		...
		if(!empty($field['config']['option'])){
			...
			*/
			...
			foreach($field['config']['option'] as $option_key=>$option){
				...
				<div class="checkbox">
				<?php } ?>
				<label<?php if(!empty($field['config']['inline'])){ ?> class="checkbox-inline"<?php } ?> for="<?php echo $field_id . '_' . $option_key; ?>"><input type="checkbox" data-field="<?php echo $field_base_id; ?>" id="<?php echo $field_id . '_' . $option_key; ?>" class="<?php echo $field_id; ?>" name="<?php echo $field_name; ?>[<?php echo $option_key; ?>]" value="<?php echo $option['value']; ?>" <?php if( in_array( $option['value'], (array) $field_value) ){ ?>checked="checked"<?php } ?>> <?php echo $option['label']; ?></label>&nbsp;
				<?php if(empty($field['config']['inline'])){ ?>
				</div>
				<?php } ?>
				<?php
