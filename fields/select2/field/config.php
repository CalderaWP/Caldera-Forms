...
<div class="caldera-config-group">
	<label><?php _e('Multiple', 'caldera-forms'); ?></label>
	<div class="caldera-config-field">
		<label><input type="checkbox" id="{{_id}}_is_multi" class="field-config" name="{{_name}}[multi]" value="1" {{#if multi}}checked="checked"{{/if}}> <?php _e('Enable multiple selections', 'caldera-forms'); ?></label>
	</div>
</div>
<div class="caldera-config-group">
...
<div class="caldera-config-group">
	<label for="{{_id}}_border"><?php _e('Border', 'caldera-forms'); ?></label>
	<div class="caldera-config-field">
