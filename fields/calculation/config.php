<div class="caldera-config-group">
	<label for="{{_id}}_element">
        <?php esc_html_e('Element', 'caldera-forms'); ?>
    </label>
...
<div class="caldera-config-group">
	<label for="{{_id}}_classes">
        <?php esc_html_e('Classes', 'caldera-forms'); ?>
    </label>
	<div class="caldera-config-field">
...
<div class="caldera-config-group">
	<label for="{{_id}}_before">
        <?php esc_html_e('Before', 'caldera-forms'); ?>
    </label>
	<div class="caldera-config-field">
...
<div class="caldera-config-group">
	<label for="{{_id}}_after">
        <?php esc_html_e('After', 'caldera-forms'); ?>
    </label>
	<div class="caldera-config-field">
...
<div class="caldera-config-group">
	<div class="caldera-config-field">
		<label for="{{_id}}_fixed">
            <input id="{{_id}}_fixed" type="checkbox" class="field-config" name="{{_name}}[fixed]" value="1" {{#if fixed}}checked="checked"{{/if}}>
            <?php esc_html_e('Money Format', 'caldera-forms'); ?>
        </label>
	</div>
</div>
...
<div class="caldera-config-group" id="{{_id}}_thousand_separator">
	<label for="{{_id}}_sep">
        <?php esc_html_e('Separator', 'caldera-forms'); ?>
    </label>
	<div class="caldera-config-field">
		<input id="{{_id}}_sep" type="text" class="field-config" name="{{_name}}[thousand_separator]" value="{{#if thousand_separator}}{{thousand_separator}}{{else}},{{/if}}" aria-describedby="{{_id}}_sep-description">
		<p class="description" id="{{_id}}_sep-description">
            <?php esc_html_e('Setup a custom thousand separator. e.g 10,000.00 or 10.000.00', 'caldera-forms'); ?>
        </p>
	</div>
</div>
...
<div class="caldera-config-group">
	<div class="caldera-config-field">
		<label for="{{_id}}_manual">
            <input id="{{_id}}_manual" type="checkbox" class="field-config" name="{{_name}}[manual]" value="1" {{#if manual}}checked="checked"{{/if}}>
            <?php esc_html_e('Manual Formula', 'caldera-forms'); ?>
        </label>
	</div>
</div>
<div id="{{_id}}_autobox">
	<div class="caldera-config-group caldera-config-group-full">
		...
		>
            <?php esc_html_e('Add Operator Group', 'caldera-forms'); ?>
        </button>
	</div>
	<br>
...
<div id="{{_id}}_manualbox" style="display:none;">
	<textarea name="{{_name}}[manual_formula]" class="field-config block-input" aria-describedby="{{_id}}_manualbox-description">
        {{manual_formula}}
    </textarea>
	<p class="description" id="{{_id}}_manualbox-description">
        <?php echo __('Use %field_slug% as field value variables', 'caldera-forms'); ?>
    </p>
</div>
<br><br><br>
{{#script}}
