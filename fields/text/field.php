...
<?php echo $wrapper_before; ?>
	...
	<?php echo $field_before; ?>
		<input <?php echo $field_placeholder; ?> type="<?php echo esc_attr( $type_override ); ?>" <?php echo $mask; ?> <?php if(!empty( $sync ) ){ ?>data-binds="<?php echo esc_attr( json_encode( $binds ) ); ?>" data-sync="<?php echo esc_attr( $field['config']['default'] ); ?>"<?php } ?> data-field="<?php echo $field_base_id; ?>" class="<?php echo $field_class; ?>" id="<?php echo $field_id; ?>" name="<?php echo $field_name; ?>" value="<?php echo esc_attr( $field_value ); ?>" <?php echo $field_required; ?>>
