<div class="caldera-config-group">
	<label>
		<?php esc_html__('From Name', 'caldera-forms'); ?>
	</label>
...
<div class="caldera-config-group">
	<label><?php esc_html__('From Email', 'caldera-forms'); ?> </label>
	<div class="caldera-config-field">
...
<div class="caldera-config-group">
	<label>
		<?php esc_html__('Email Subject', 'caldera-forms'); ?>
	</label>
	<div class="caldera-config-field">
...
<div class="caldera-config-group">
	<label>
		<?php esc_html__('Recipient Name', 'caldera-forms'); ?>
	</label>
	<div class="caldera-config-field">
...
<div class="caldera-config-group">
	<label>
		<?php esc_html__('Recipient Email', 'caldera-forms'); ?>
	</label>
	<div class="caldera-config-field">
...
<div class="caldera-config-group">
	<label>
		<?php esc_html__('Message', 'caldera-forms'); ?>
	</label>
	<div class="caldera-config-field">
