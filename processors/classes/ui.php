...
class Caldera_Forms_Processor_UI {
	...
	public static function ssl_notice( $name ) {
		...
		return sprintf( '<div class="error"><p>%1s</p></div>', sprintf( __( '%1s requires a valid SSL certificate. It will only function in test mode unless SSL/HTTPS is used. Your site does not appear to be using the secure HTTPS protocol.', 'caldera-forms' ), $name ) );
