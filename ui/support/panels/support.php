...
?>
	...
	<ul>
		<li>
			<strong><?php esc_html_e( 'Priority Support', 'caldera-forms' ); ?></strong> <?php esc_html_e( 'Direct support from our team, your questions answered within one business day.', 'caldera-forms' ); ?> <a href="https://calderawp.com/support#priority-support" rel="nofollow"><?php esc_html_e( 'Learn more here.', 'caldera-forms' ); ?></a>
		</li>
		<li>
			<strong><?php esc_html_e( 'Form Creation.', 'caldera-forms' ); ?></strong> <?php esc_html_e( 'Got a really trick form and not a lot of time?', 'caldera-forms' ); ?> <a href="https://calderawp.com/caldera-forms-services#cf-dfy" rel="nofollow"><?php esc_html_e( 'We can help.', 'caldera-forms' ); ?></a></li>
