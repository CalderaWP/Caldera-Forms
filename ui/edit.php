...
<div class=\"caldera-config-group-toggle-options\" {{#if auto}}style=\"display:none;\"{{/if}} data-field=\"{{_id}}\">
	<div class=\"caldera-config-group caldera-config-group-full\">
		<button type=\"button\" class=\"button add-toggle-option\" style=\"width: 180px;\" data-field=\"{{_id}}\">" . esc_html__( 'Add Option', 'caldera-forms' ) . "</button>
		<button type=\"button\" data-bulk=\"#{{_id}}_bulkwrap\" class=\"button add-toggle-option\" style=\"width: 190px;\" data-field=\"{{_id}}\">" . esc_html__( 'Bulk Insert / Preset', 'caldera-forms' ) . "</button>
